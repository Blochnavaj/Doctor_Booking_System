  ...
  return (
    <div id='speciality' className='flex flex-col gap-4 items-center py-16 text-gray-800'> 
      ...
      {specialityData.map((items,index)=>(
             <Link  className='flex flex-col items-center text-xs cursor-pointer flex-shrink-0 hover:translate-y-[-10px] transition-all duration-500 ' key={index} to={`doctor/${items.speciality}`}>
